...
class SimpleCaptcha {
  ...
  captcha(config) {
    ...
    submitButton.addEventListener("click", function (event) {
      ...
      var capchaValue = parseInt(inputElement.value);
      console.log(captchaValuesResult.value1, captchaValuesResult.value2, capchaValue);

      if (captchaValuesResult.value1 + captchaValuesResult.value2 == capchaValue) {
        ...
        flagElement.textContent = "Captcha is invalid!";
        const newValues = captchaValues();
        spanElement.textContent = `${newValues.value1} + ${newValues.value2} = `;
      }
    });
